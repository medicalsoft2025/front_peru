...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            <div class="pb-9">
                <h2 class="mb-4">Citas por estado</h2>
    ...
    <script>
        ...
        function jsonToXml(jsonData) {
            ...
            let xmlContent = "<dates>\n";

            jsonData.forEach(date => {
                xmlContent += "  <date>\n";
                for (let key in date) {
                    xmlContent += `    <${key}>${date[key]}</${key}>\n`;
                }
                xmlContent += "  </date>\n";
            });
        ...
        document.getElementById("exportPDF").addEventListener("click", function(e) {
            ...
            fetch('Reportes/generate_pdf.php', {
                ...
                .then((blob) => {
                    ...
                    link.href = url;
                    link.download = 'reporteCitas.pdf'; // Nombre del archivo
