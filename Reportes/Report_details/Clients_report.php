...
<body>
    ...
    <script>
        ...
        document.getElementById("exportExcel").addEventListener('click', function() {
            ...
            XLSX.writeFile(workbook, "reportClients.xlsx");
        });
        ...
        function jsonToXml(jsonData) {
            ...
            let xmlContent = "<clients>\n";

            jsonData.forEach(client => {
                xmlContent += "  <client>\n";
                for (let key in client) {
                    xmlContent += `    <${key}>${client[key]}</${key}>\n`;
                }
                xmlContent += "  </client>\n";
            });
        ...
        document.getElementById("exportPDF").addEventListener("click", function(e) {
            ...
            fetch('Reportes/generate_pdf.php', {
                ...
                .then((blob) => {
                    ...
                    link.href = url;
                    link.download = 'reportClients.pdf'; // Nombre del archivo
