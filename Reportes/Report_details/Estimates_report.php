...
<body>
    ...
    <script>
        ...
        document.getElementById("exportExcel").addEventListener('click', function() {
            ...
            XLSX.writeFile(workbook, "reportePresupuestos.xlsx");
        });
        ...
        document.getElementById("exportXML").addEventListener("click", function() {
            ...
            a.href = url;
            a.download = "reportePresupuestos.xml";
        ...
        function jsonToXml(jsonData) {
            ...
            let xmlContent = "<estimates>\n";

            jsonData.forEach(estimate => {
                xmlContent += "  <estimate>\n";
                for (let key in estimate) {
                    xmlContent += `    <${key}>${estimate[key]}</${key}>\n`;
                }
                xmlContent += "  </estimate>\n";
            });

            xmlContent += "</estimates>";
        ...
        document.getElementById("exportPDF").addEventListener("click", function(e) {
            ...
            fetch('Reportes/generate_pdf.php', {
                ...
                .then((blob) => {
                    ...
                    link.href = url;
                    link.download = 'reportePresupuestos.pdf'; // Nombre del archivo
