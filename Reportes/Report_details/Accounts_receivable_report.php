...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            <div class="pb-9">
                <h2 class="mb-4">Cuentas a cobrar</h2>
    ...
    <script>
        ...
        document.getElementById("exportExcel").addEventListener('click', function() {
            ...
            XLSX.writeFile(workbook, "cuentasCobrar.xlsx");
        });
        ...
        function jsonToXml(jsonData) {
            ...
            let xmlContent = "<cuentas>\n";

            jsonData.forEach(account => {
                xmlContent += "  <cuenta>\n";
                for (let key in account) {
                    xmlContent += `    <${key}>${account[key]}</${key}>\n`;
                }
                xmlContent += "  </cuenta>\n";
            });
        ...
        document.getElementById("exportPDF").addEventListener("click", function(e) {
            ...
            const jsonData = JSON.stringify({
                ...
                title: "Reporte de Cuentas a cobrar"
            });
            ...
            fetch('Reportes/generate_pdf.php', {
                ...
                .then((blob) => {
                    ...
                    link.href = url;
                    link.download = 'reporte_cuentas.pdf'; // Nombre del archivo
