...
export const SalesInvoicesFormat = ({
  data,
  columns,
  title,
  filters
}) => {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, title, " | ", filters.dateRange), filters && /*#__PURE__*/React.createElement("div", {
    className: "mb-3"
  }, /*#__PURE__*/React.createElement("strong", null, "Filtros aplicados:")), /*#__PURE__*/React.createElement("table", {
