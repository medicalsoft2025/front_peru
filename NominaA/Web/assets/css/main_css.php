...
--color-secundario: <?= htmlspecialchars($colorSecundario) ?>;
...
--heading-color: var(--color-secundario); /* Color for headings, subheadings and title throughout the website */
--accent-color: var(--color-secundario); /* Accent color that represents your brand on the website. It's used for buttons, links, and other elements that need to stand out */
...
--surface-color: var(--color-secundario);
