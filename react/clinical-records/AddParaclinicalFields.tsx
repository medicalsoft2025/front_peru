...
import { ExamRecipeResultFormInputs } from './AddParaclinicalForm';

interface AddParaclinicalFieldsProps {
    control: Control<ExamRecipeResultFormInputs>;
    errors: FieldErrors<ExamRecipeResultFormInputs>;
    patientExamRecipes: any[];
    file: File | null;
    fileUrl: string | null;
    onFileChange: (file: File | null) => void;
}

export const AddParaclinicalFields: React.FC<AddParaclinicalFieldsProps> = ({
    control,
    errors,
    patientExamRecipes,
    file,
