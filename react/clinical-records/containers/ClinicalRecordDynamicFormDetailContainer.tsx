...
export const ClinicalRecordDynamicFormContainerDetail = () => {
    ...
    return (
        <>
            ...
            <ClinicalRecordDynamicForm ref={dynamicFormRef} dynamicFormId={dynamicFormId} onSubmit={handleFormSubmit} />
            <div className="mt-3">
