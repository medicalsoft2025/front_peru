import { DynamicArrayFieldFormat, DynamicContainerType, DynamicElementType, DynamicFieldTypes } from "../../dynamic-form/interfaces/models";
import { JsonConfigMetadata } from "../interfaces/configurator-models";

export const asyncValidationMetadata: JsonConfigMetadata = {
    defaultData: {
        endpoint: "",
        method: "POST",
        debounceTime: 300,
    ...
    fields: [
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    "inputType": "select",
                    "options": [
                        { "value": "field", "label": "Valor del campo" },
                        { "value": "url", "label": "URL Param" },
        ...
        },
        {
            ...
            columns: [
                { key: "name", label: "Nombre", inputType: "text", required: true, path: "name" },
                { key: "value", label: "Valor", inputType: "text", required: true, path: "value" }
            ],
            defaultValue: [],
...
export const asyncOptionsMetadata: JsonConfigMetadata = {
    defaultData: {
        endpoint: "",
        method: "GET",
        labelKey: "label",
...
export const ruleMetadata: JsonConfigMetadata = {
    defaultData: {
        condition: [],
        actions: []
    },
            ...
            fields: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { value: "sumGreaterThan", label: "Suma mayor que (Array)" },
                        { value: "sumLessThan", label: "Suma menor que (Array)" },
                        { value: "sumEquals", label: "Suma igual a (Array)" },
                        { value: "anyEquals", label: "Alguno igual a (Array)" },
                        { value: "allEquals", label: "Todos igual a (Array)" }
                    ],
                },
                {
                    path: "source",
                    ...
                    options: [
                        { value: "static", label: "Valor Estático" },
                        { value: "field", label: "Campo del Formulario" }
                    ],
                    defaultValue: "static"
                },
                {
            ...
            fields: [
                {
                    ...
                    options: [
                        ...
                        { value: "hide", label: "Ocultar campo" },
                        { value: "enable", label: "Habilitar campo" },
                        { value: "disable", label: "Deshabilitar campo" },
                        { value: "setValue", label: "Establecer valor" },
                        { value: "setOptions", label: "Establecer opciones" },
                        { value: "validationError", label: "Error de validación" }
                    ]
                },
                {
                    path: "target",
...
export const arrayConfigMetadata: JsonConfigMetadata = {
    defaultData: {
        format: "default"
    },
    fields: [
        ...
        },
        {
            ...
            visible: { format: ["table"] as DynamicArrayFieldFormat[] },
            fields: [
                {
                    path: "paginator",
                    key: "paginator",
                ...
                },
                {
                    ...
                    rules: [
                        {
                            conditions: [{ field: "paginator", operator: "equals", value: true }],
                            effect: { visible: true }
                        },
                        {
                            conditions: [{ field: "paginator", operator: "notEquals", value: true }],
...
export const elementConfigMetadata: JsonConfigMetadata = {
    defaultData: {
        children: []
    },
    fields: [
            ...
            rules: [
                {
                    ...
                    conditions: [
                        { field: "type", operator: "in", value: ["card", "tabs", "tab", "accordion", "stepper", "container"] }
                    ],
            ...
            rules: [
                {
                    ...
                    effect: { visible: false, defaultValue: "container" }
                },
                {
                    conditions: [
                        { field: "$parent.type", operator: "equals", value: "array" },
                        { field: "$parent.arrayConfig.format", operator: "notEquals", value: "table" }
                    ],
                    effect: { visible: true }
                }
            ]
        ...
        },
        {
            ...
            rules: [
                {
                    conditions: [
                        { field: "type", operator: "in", value: ["text", "number", "date", "password", "select", "multiselect", "textarea"] }
                    ],
                    effect: { visible: true }
                },
                {
                    conditions: [
                        { field: "type", operator: "notIn", value: ["text", "number", "date", "password", "select", "multiselect", "textarea"] }
                    ],
                    effect: { visible: false }
                }
            ]
        },
        {
            ...
            label: "Obligatorio",
            inputType: "checkbox",
            visible: { type: ["text", "number", "date", "password", "select", "multiselect", "checkbox", "radio"] as DynamicElementType[] }
        },
        {
            path: "disabled",
            key: "disabled",
        ...
        },
        {
            ...
            inputType: "text",
            visible: { type: ["form", "card", "tabs", "tab", "accordion", "stepper", "array"] as DynamicElementType[] }
        },
        {
            path: "divider",
            key: "divider",
        ...
        },
        {
            ...
            fields: [
                { key: "label", label: "Texto", inputType: "text", required: true, path: "label" },
                { key: "value", label: "Valor", inputType: "text", required: true, path: "value" }
            ],
            visible: { type: ["select", "radio", "multiselect"] as DynamicElementType[] }
        },
        {
            path: "asyncOptions",
            key: "asyncOptions",
            ...
            visible: { type: ["select", "multiselect"] as DynamicElementType[] }
        },
        {
        ...
        },
        {
            ...
            inputType: "nestedObject",
            visible: { type: ["array"] as DynamicElementType[] },
        ...
        },
        {
            ...
            label: "Lineal",
            inputType: "checkbox",
            visible: { type: ["stepper"] as DynamicElementType[] }
        },
        {
            ...
            inputType: "checkbox",
            visible: { type: ["form", "stepper", "card"] as DynamicElementType[] },
            rules: [
                {
                    conditions: [{ field: "type", operator: "equals", value: "form" }],
                    effect: { label: "Habilitar botón Guardar (Submit)" }
                }
            ]
        },
        {
...
export const finalNestedContainerConfigMetadata: JsonConfigMetadata = {
    defaultData: {
        children: []
    },
    fields: [
        ...elementConfigMetadata.fields,
        {
            path: "children",
            key: "children",
            ...
            defaultValue: [],
            visible: { type: ["form", "stepper", "card", "accordion", "array", "container", "tabs"] as DynamicElementType[] },
            rules: [
                {
                    conditions: [{ field: "type", operator: "equals", value: "stepper" }],
                    effect: { addButtonLabel: "Añadir paso", label: "Pasos del Stepper" }
                },
                {
                    conditions: [{ field: "type", operator: "equals", value: "tabs" }],
                    effect: { addButtonLabel: "Añadir pestaña", label: "Pestañas" }
                },
                {
                    conditions: [{ field: "type", operator: "equals", value: "accordion" }],
                    effect: { addButtonLabel: "Añadir sección", label: "Secciones del acordeón" }
                },
                {
                    conditions: [
                        { field: "type", operator: "equals", value: "array" },
                        { field: "arrayConfig.format", operator: "equals", value: "table" }
                    ],
                    effect: { addButtonLabel: "Añadir columna", label: "Columnas" }
                }
            ],
            fields: [...elementConfigMetadata.fields, {
                ...
                removeButtonLabel: "Eliminar elemento",
                defaultValue: [],
                visible: { type: ["form", "stepper", "card", "accordion", "array", "container"] as DynamicElementType[] },
                rules: [
                    {
                        conditions: [{ field: "type", operator: "equals", value: "stepper" }],
                        effect: { addButtonLabel: "Añadir paso", label: "Pasos del Stepper" }
