...
export const TaxesMapperUpdate = (data: TaxFormInputs): UpdateTaxDTO => {
  ...
  if (data.accounting_account_id !== undefined) {
    updateData.accounting_account_id = data.accounting_account_id ?
      Number(data.accounting_account_id) : null;
  }

  if (data.accounting_account_reverse_id !== undefined) {
    updateData.accounting_account_reverse_id = data.accounting_account_reverse_id ?
      Number(data.accounting_account_reverse_id) : null;
  }

  if (data.sell_accounting_account_id !== undefined) {
    updateData.sell_accounting_account_id = data.sell_accounting_account_id ?
      Number(data.sell_accounting_account_id) : null;
  }

  if (data.sell_reverse_accounting_account_id !== undefined) {
    updateData.sell_reverse_accounting_account_id = data.sell_reverse_accounting_account_id ?
      Number(data.sell_reverse_accounting_account_id) : null;
  }
