...
export const AISchedulingForm: React.FC<AISchedulingFormProps> = ({ onAvailabilityFound, onLoading }) => {
    ...
    const handleSearchIA = async () => {
        ...
        onLoading(true);
        try {
            const response = await aiService.userAvailabilitiesIntelligentSearch({ instruction });
            ...
            if (result.availabilities) {
                ...
                const filters = { ...result.filters_used, instruction };
    ...
    return (
        <div className="p-4 border rounded bg-primary bg-opacity-10 border-primary border-opacity-25">
            <div className="d-flex align-items-center mb-3 text-primary">
                <i className="fa-solid fa-wand-magic-sparkles me-2 fa-lg"></i>
                <h6 className="mb-0 fw-bold">Agendamiento Inteligente</h6>
            </div>
            ...
            <div className="mb-3">
                <InputTextarea
                    ...
                    placeholder="Ej: Necesito una cita de cardiología para la próxima semana en las mañanas..."
                    autoResize
                />
            </div>
