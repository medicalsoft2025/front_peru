...
export const Report606Purchases: React.FC<any> = () => {
  ...
  const {
    ...
    fetchFunction: (params) => loadFormat606Purchases(params),
    defaultPerPage: 10,
  });

  async function loadFormat606Purchases(params: any = { perPage: 10 }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      body: (rowData: any) =>
        `${getIncomeType(rowData?.income_type?.accounting_account?.category || "")}`,
    },
    {
      field: "created_at",
