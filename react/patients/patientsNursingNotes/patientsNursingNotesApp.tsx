...
import { useNotasEnfermeria } from './hooks/usePatientsNursingNotes';
import PatientsNursingNotesModal from './modal/PatientsNursingNotesModal';
import { PatientsNursingNotesTable } from './table/PatientsNursingNotesTable';

export interface NursingNotesConfigProps {
    patientId: string | number; // Aceptar number también
    onConfigurationComplete?: (hasNotes: boolean) => void;
}

export const patientsNursingNotesApp: React.FC<NursingNotesConfigProps> = ({
    patientId,
