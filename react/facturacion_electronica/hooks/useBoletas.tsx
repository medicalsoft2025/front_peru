...
export const useBoletas = () => {
  ...
  const getBoletaDetails = useCallback(async (boletaId: any) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const createBoleta = useCallback(async (boletaData: any) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const updateBoleta = useCallback(async (boletaId: any, boletaData: any) => {
    setLoading(true);
    setError(null);
    try {
  ...
  // ---------------------------
const descargarPdfBoleta = useCallback(async (boletaId: any) => {
  setLoading(true);
  setError(null);
  try {
  ...
  const descargarXmlBoleta = useCallback(async (boletaId: any) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const descargarCdrBoleta = useCallback(async (boletaId: any) => {
    setLoading(true);
    setError(null);
    try {
