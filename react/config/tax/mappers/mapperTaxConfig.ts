import { CreateTaxDTO, UpdateTaxDTO } from "../interfaces/taxConfigDTO"
import { TaxFormInputs } from "../interfaces/taxConfigForm"

export const TaxMapperCreate = (data: TaxFormInputs): CreateTaxDTO => {
    return {
...
export const TaxMapperUpdate = (data: TaxFormInputs): UpdateTaxDTO => {
    return {
        name: data.name,
        document_type: data.document_type,
