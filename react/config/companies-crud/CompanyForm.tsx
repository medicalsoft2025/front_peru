...
import {
  Company,
  WhatsAppStatus,
} from "../company-configuration/types/consultorio";
...
import IntegrationsTab from "../company-configuration/components/IntegrationsTab";
        ...
        <div className="col-12">
          ...
          >
            ...
            <TabPanel
              ...
              disabled={isNew}
            >
              <RepresentativeTab companyId={companyId} />
            </TabPanel>
            ...
            <TabPanel
              ...
              disabled={isNew}
            >
              <BranchesTab companyId={companyId} />
            </TabPanel>
            <TabPanel
