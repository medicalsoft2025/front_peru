    ...
    return (
        <div className="skeleton-navbar" style={{ width: '100%', overflow: 'hidden' }}>
            <div className="desktop-skeleton hidden md:block">
                <div className="d-flex align-items-center justify-content-center w-full" style={{ height: '64px', margin: 'auto' }}>
            ...
            <div className="mobile-skeleton block md:hidden">
                <div className="flex align-items-center justify-content-center w-full" style={{ height: '60px', margin: 'auto' }}>
