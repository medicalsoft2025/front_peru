...
export const usePatientEvolutions = (props: { patientId: string, clinicalRecordId?: string, filters: EvolutionNotesFilters }) => {

    const { patientId, clinicalRecordId, filters } = props;
    ...
    const {
        ...
        queryFn: async (paginationParams) => {
            const { page, perPage, search } = paginationParams;
