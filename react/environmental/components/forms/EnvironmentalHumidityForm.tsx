...
interface EnvironmentalHumidityFormProps {
    formId: string;
    date: Date;
    onSave: (data: StoreEnvironmentalHumidityRecordParams) => Promise<any>;
}

export const EnvironmentalHumidityForm = ({ formId, date, onSave }: EnvironmentalHumidityFormProps) => {
        ...
        <form id={formId} onSubmit={handleSubmit(onSubmit)} className="d-flex flex-column gap-3">
            <div className="d-flex flex-column gap-2">
                <div className="d-none d-md-flex row px-2 mb-2 text-muted fw-bold">
                    ...
                    <div className="col-4">AM (%)</div>
                    <div className="col-4">PM (%)</div>
                </div>
                    ...
                    <div key={field.id} className="card p-3 shadow-sm border-0 mb-2">
                        <div className="row align-items-center">
                            ...
                            <div className="col-6 col-md-4">
                                <label className="d-block d-md-none mb-1 text-muted small">AM (%)</label>
                                <Controller
                            ...
                            <div className="col-6 col-md-4">
                                <label className="d-block d-md-none mb-1 text-muted small">PM (%)</label>
                                <Controller
