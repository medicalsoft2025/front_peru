...
import { InventariableFormInputs, InventariableFormProps } from "./interfaces/InventariableForm.js";

const InventariableForm: React.FC<InventariableFormProps> = ({
    formId,
    onHandleSubmit,
    initialData,
}) => {
    const {
        ...
        trigger,
        reset,
    } = useForm<InventariableFormInputs>({
    ...
    const onSubmit: SubmitHandler<InventariableFormInputs> = (data) =>
        onHandleSubmit(data);
    ...
    const getFormErrorMessage = (name: keyof InventariableFormInputs) => {
        return (
...
export default InventariableForm;
