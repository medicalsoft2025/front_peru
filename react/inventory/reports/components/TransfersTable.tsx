...
export const TransfersTable: React.FC<TransfersTableProps> = ({ deposits, loading }) => {
    const [expandedRows, setExpandedRows] = useState<any>(null);

    const rowExpansionTemplate = (deposit: any) => {
        return (
            <div className="p-3">
                <h6 className="mb-2">Detalle de Traslados - {deposit.deposit_name}</h6>
                <DataTable
                ...
                >
                    ...
                    <Column
                        ...
                        sortable
                        body={(rowData) => (
                            <span className={rowData.type === 'exit' ? 'fw-bold' : ''}>
                    ...
                    <Column
                        ...
                        sortable
                        body={(rowData) => (
                            <span className={rowData.type === 'entry' ? 'fw-bold' : ''}>
    ...
    return (
        <DataTable
            ...
            loading={loading}
            emptyMessage="No se encontraron depósitos con traslados relacionados"
        ...
        >
            ...
            <Column
                ...
                body={(rowData) => <span className="text-info fw-bold">{formatCurrency(rowData.total_value)}</span>}
                sortable
