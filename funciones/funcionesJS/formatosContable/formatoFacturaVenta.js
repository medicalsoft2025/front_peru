...
export function generarFormatoFacturaVenta(invoice, tipo) {
...
<table style="width: 100%; margin-top: 20px;">
  <tr>
    ...
    `;
  generatePDFFromHTML(htmlInvoice, companyData, pdfConfigView);
}
export default generarFormatoFacturaVenta;
