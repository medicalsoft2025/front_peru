  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content bg-body-highlight p-6">
      ...
      <div class="modal-body px-0" id="modalFacturaEmpresa_p1">
        ...
        <input type="hidden" id="usuario_id" value="<?=$_SESSION['ID']?>" required>
        <div class="col-md-12 row">
            ...
            <div class="col-md-4">
              ...
              <input class="form-control" required type="date" id="fechaVencimiento" value="<?= date('Y-m-d')?>" placeholder="Fecha de Vencimiento">
            </div>
