...
?>
<div class="modal fade" id="modalNewNoteDebit" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nota de Débito</h5><button class="btn btn-close p-1" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
            ...
            <div class="row g-3 mb-3">
              ...
              <div class="col-sm-6">
                <div class="mb-2">
                  ...
                  <input class="form-control" type="text" name="contact" placeholder="Contacto" id="contact" disabled >
                </div>
              </div>
            </div>
            ...
            <div class="row g-3 mb-3">
              ...
              <div class="col-sm-6">
                <div class="mb-2">
                  ...
                  <input class="form-control" type="text" name="number" placeholder="Número" id="number" disabled>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row g-3 mb-3">
                <div class="col-sm-4">
                  <div class="mb-2 mb-sm-0">
                    ...
                    <input class="form-control" type="number" name="quantity" placeholder="Cantidad" id="quantity">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="mb-2">
                    <label class="form-label text-body" for="unitValue">Valor Unitario</label>
                    <input class="form-control" type="number" name="unitValue" placeholder="Valor Unitario" id="unitValue">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="mb-2 mb-sm-0">
                    <label class="form-label text-body" for="discount">Descuento</label>
                    <input class="form-control" type="number" name="discount" placeholder="Descuento" id="discount">
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="mb-2">
                    <label class="form-label text-body" for="taxCharge">Impuesto cargo</label>
                    <input class="form-control" type="text" name="taxCharge" placeholder="Impuesto cargo" id="taxCharge">
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="mb-2">
                    <label class="form-label text-body" for="taxWithholding">Impuesto retencion</label>
                    <input class="form-control" type="text" name="taxWithholding" placeholder="Impuesto retencion" id="taxWithholding">
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="mb-2 mb-sm-0">
                    ...
                    <input class="form-control" type="text" name="total" placeholder="Total" id="total" disabled>
                  </div>
                </div>
