!(function () {
 ...
 const Ao = (e) => (t) => !!t && t.nodeType === e,
  ...
  Zr = (e, t) =>
   ...
   ((e) => To(e) && "A" === e.nodeName && !e.hasAttribute("href") && (e.hasAttribute("name") || e.hasAttribute("id")))(e) ||
   es(e),
 ...
 const os = (e, t = !0) =>
  ...
  Fs = {
   ...
   getEncodeFunc: (e, t) => {
    ...
    return o.named && o.numeric
     ? (e, t) =>
      e.replace(t ? Es : Ns, (e) => (void 0 !== Ts[e] ? Ts[e] : void 0 !== n[e] ? n[e] : e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : "&#" + e.charCodeAt(0) + ";"))
     : o.named
      ? t
       ? (e, t) => Is(e, t, n)
       : Is
  ...
  Qs = (e = {}) => {
   ...
   e.valid_elements
    ...
    A("+ol[ul|ol],+ul[ul|ol]"),
    $s({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, (e, t) => {
  ...
  Zs = { keyLocation: !0, layerX: !0, layerY: !0, returnValue: !0, webkitMovementX: !0, webkitMovementY: !0, keyIdentifier: !0, mozPressure: !0 },
  ea = (e, t) => {
   const n = null != t ? t : {};
     ...
     r.domLoaded && "ready" === t && "complete" === e.readyState
      ...
      : (r.hasFocusIn ||
       ...
       s
        ...
        : ((r.events[l][t] = s = [{ func: n, scope: o }]), (s.fakeName = f), (s.capture = m), (s.nativeHandler = u), "ready" === t ? aa(e, u, r) : oa(e, f || t, u, m)));
   }
   return (e = s = null), n;
  }
  unbind(e, t, n) {
 ...
 const la = Tt.each,
  ...
  ba = (e, t = {}) => {
   const n = {},
    ...
    r = {};
   let s = 0;
   const a = ws.forElement(mn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
    i = [],
     ...
     T(e, (e) => {
      if (To(e)) {
       const r = mn(e),
        ...
        a = Wt(r, n),
        i = Y[n];
       i && i.set ? i.set(r.dom, s, n) : ma(r, n, s), a !== s && t.onSetAttrib && t.onSetAttrib({ attrElm: r.dom, attrName: n, attrValue: s });
      }
     });
    },
 ...
 const Ha = (e) => {
  ...
  Wa = (e, t, n = P) => {
   ...
   return { current: () => M.from(o.current()).filter(zo), next: () => r("next"), prev: () => r("prev"), prev2: () => r("prev2") };
  },
  Ka = (e, t) => {
  ...
  Ga = Math.round,
  Ya = (e) => (e ? { left: Ga(e.left), top: Ga(e.top), bottom: Ga(e.bottom), right: Ga(e.right), width: Ga(e.width), height: Ga(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 }),
   ...
   return void 0 !== e.replacement
    ? m(e.replacement)
     ? 0 === e.start.length
      ...
      : Wi.value({ type: "inline-command", start: "", end: e.start, cmd: "mceInsertContent", value: e.replacement })
    ...
    show: (e, c) => {
     ...
     if (!n(c))
      return (
       ...
       oc(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
       u
      );
     {
      const n = ((e, t, n) => {
   ...
   ((e, t, n = !1) =>
    2 === t
     ...
     : 3 === t
      ? ((e) => {
       const t = e.getRng();
       return { start: Bi(e.dom.getRoot(), xi.fromRangeStart(t)), end: Bi(e.dom.getRoot(), xi.fromRangeEnd(t)), forward: e.isForward() };
      })(e)
      : t
    ...
    if (t) {
     ...
     if (((e) => m(e.start))(t))
      return ((e, t) => {
       ...
       return Dt(n, o, (n, o) => {
        const r = e.createRng();
        return r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), { range: r, forward: au(t) };
       });
      })(n, t);
     if (((e) => xe(e, "id"))(t))
      return ((e, t) => {
       ...
       return Dt(n, o.or(n), (n, o) => {
        const r = e.createRng();
        return r.setStart(iu(e, n.container()), n.offset()), r.setEnd(iu(e, o.container()), o.offset()), { range: r, forward: au(t) };
       });
      })(n, t);
     if (ru(t))
      return ((e, t) =>
 ...
 const bu = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
  ...
  vm = (e, t, n, o = !1) => {
   ...
   return (
    ...
    To(a) && a.hasChildNodes() && ((a = ni(a, t.collapsed ? i : i - 1)), zo(a) && (i = a.data.length)),
    (r = lm(e, r)),
    (a = lm(e, a)),
    bm(r) && ((r = rm(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), zo(r) && (s = t.collapsed ? r.length : 0)),
    bm(a) && ((a = rm(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), zo(a) && (i = t.collapsed ? 0 : a.length)),
    t.collapsed &&
    ...
    (nm(l) || l.block_expand) && ((nm(l) && zo(r) && 0 !== s) || (r = hm(e, n, r, s, !0)), (nm(l) && zo(a) && i !== a.data.length) || (a = hm(e, n, a, i, !1))),
    om(l) && ((r = fm(e, n, t, r, "previousSibling")), (a = fm(e, n, t, a, "nextSibling"))),
    (em(l) || tm(l)) && ((r = gm(e, n, r, "previousSibling")), (a = gm(e, n, a, "nextSibling")), em(l) && (e.isBlock(r) || (r = hm(e, n, r, s, !0)), e.isBlock(a) || (a = hm(e, n, a, i, !1)))),
   ...
   const x = (e) => C(e) && (Ko(e) || n.is(e, "figure.image")),
    ...
    A = (e) => {
     ...
     (o = e.screenX - u),
      ...
      c && (Lm(o) > Lm(r) ? ((v = Mm(b * p)), (b = Mm(v / p))) : ((b = Mm(v / p)), (v = Mm(b * p)))),
      R(i, b, v),
      (C = d.startPos.x + o),
      (S = d.startPos.y + r),
      (C = C > 0 ? C : 0),
 ...
 const $m = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
  ...
  Wm = { before: qm.before, on: qm.on, after: qm.after, cata: (e, t, n, o) => e.fold(t, n, o), getStart: (e) => e.fold(R, R, R) },
  ...
  Gm = {
   ...
   getWin: (e) => {
    const t = ((e) => e.match({ domRange: (e) => mn(e.startContainer), relative: (e, t) => Wm.getStart(e), exact: (e, t, n, o) => e }))(e);
    return wn(t);
   },
   range: $m,
  },
   ...
   return ((e, t) => {
    const n = ((e, t) =>
     t.match({
      ...
      exact: (t, n, o, r) => ({ ltr: De(() => zm(e, t, n, o, r)), rtl: De(() => M.some(zm(e, o, r, t, n))) }),
     }))(e, t);
    return ((e, t) => {
     const n = t.ltr();
     return n.collapsed
      ? t
       ...
       .map((e) => jm.rtl(mn(e.endContainer), e.endOffset, mn(e.startContainer), e.startOffset))
   ...
   const a = ((e, t) => {
    const n = ((e, t) => {
     ...
     if (t < n.length && !bf(n[t])) return { element: n[t], offset: 0 };
     {
      ...
      return bf(o) ? { element: e, offset: t } : "img" === Lt(o) ? { element: o, offset: 1 } : Ut(o) ? { element: o, offset: sr(o).length } : { element: o, offset: An(o).length };
     }
    })(e, t),
 ...
 const Kf = ba.DOM,
  ...
  Qf = (e, t) => {
   ((e, t) => ((e) => (e.collapsed ? M.from(ni(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) => (pr(t) ? M.some(t) : vn(e, t) ? M.none() : M.some(e))))(mn(e.getBody()), t)
    .bind((e) => Zc(e.dom))
    .fold(
     () => {
      ...
      : "text" === t.format
       ? ((e, t) => {
        const n = e.getDoc(),
         o = In(mn(e.getBody())),
         r = cn("div", n);
        Vt(r, "data-mce-bogus", "all"), qn(r, { position: "fixed", left: "-9999999px", top: "0" }), io(r, t.innerHTML), Cg(r), wg(r);
   ...
   ((e, t, n) =>
    e
     ? ((e, t) =>
      Np(t)
       .orThunk(() => Ep(t))
       .orThunk(() => ((e, t) => Qc(e, xi.after(t)).orThunk(() => Jc(e, xi.before(t))))(e, t)))(t, n)
     : ((e, t) =>
      Ep(t)
       .orThunk(() => Np(t))
       .orThunk(() =>
       ...
       : ((e, t, n, o, r) =>
        Gc(n, e.getBody(), r).fold(
         ...
         (s) =>
          ((e, t, n, o) =>
           Zc(e.dom)
            .bind((r) => eu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
            .getOr(!0))(o, n, r, s)
           ? ((e, t) => fh(e, t))(e, o)
           : ((e, t, n) =>
   ...
   return e.selection.isCollapsed() && 0 === o.length
    ...
    : ((e, t, n) => {
     ...
     return 0 !== n.length
      ...
      : ((e, t, n, o) =>
       mh(t, o).fold(
        () => ((e, t, n) => oh(t, n).bind((t) => t.fold(O(dh, e), O(ch, e), O(ih, e), O(lh, e))))(e, t, n),
        (t) => ((e, t) => fh(e, t))(e, t)
       ))(e, o, r, t);
    })(e, n, o);
  },
   ...
   m === f &&
    ...
    ((e) => {
     ...
     ((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, Ih) && Bu(mn(n), t))(t, n, o)
      ? dh(e, n, mn(o))
      : n.startContainer === n.endContainer && n.endOffset - n.startOffset == 1 && zo(n.startContainer.childNodes[n.startOffset])
       ? n.deleteContents()
   ...
   const s = e.formatter.get(t),
    ...
    u = (t) => {
     ...
     V(["underline", "line-through", "overline"], (n) => {
      To(t) && e.dom.getStyle(t, "text-decoration") === n && t.parentNode && Qu(i, t.parentNode) === n && Ib(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, void 0, t);
     });
    },
    m = (e) => {
     ...
     if (t) {
      ...
      return (
       ((e) => pu(e) && To(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]),
       zo(n) && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling),
       i.remove(t, !0),
       n
      );
     }
    ...
    f = (t) => {
     ...
     if (a.split) {
      if (((r = uf(r)), (n = Rb(e, r, !0)), (o = Rb(e, r)), n !== o)) {
       ...
       (n = Ob(i, n, "span", { id: "_start", "data-mce-type": "bookmark" })), (o = Ob(i, o, "span", { id: "_end", "data-mce-type": "bookmark" }));
       const e = i.createRng();
       e.setStartAfter(n),
        e.setEndBefore(o),
        ym(i, e, (e) => {
     ...
     a && nm(s) && !Ru(e).length
      ? ((e, t, n) => {
       ...
       if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
        ...
        let s = o ? Zh(o) : null;
        (o && (null == s ? void 0 : s.data) === Qh) || ((c = e.getDoc()), (u = eb(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
   ...
   fe(n, (n, r) => {
    const s = (n) => {
     ...
     if (n.state.get() !== a) {
      n.state.set(a);
      const e = s.getOr(t);
      Vb(n) ? n.callback(a, { node: e, format: r, parents: o }) : V(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
     }
    };
  ...
  Gv = (function e() {
    ...
    Ie = function (e) {
     ...
     if (
      (Me("uponSanitizeElement", e, { tagName: o, allowedTags: z }),
       e.hasChildNodes() && !Le(e.firstElementChild) && (!Le(e.content) || !Le(e.content.firstElementChild)) && wv(/<[/\w]/g, e.innerHTML) && wv(/<[/\w]/g, e.textContent))
     )
      return Oe(e), !0;
     ...
     return e instanceof l && !Ae(e)
      ...
      : ("noscript" !== o && "noembed" !== o) || !wv(/<\/no(script|embed)/i, e.innerHTML)
       ? (X && 3 === e.nodeType && ((t = e.textContent), (t = vv(t, D, " ")), (t = vv(t, P, " ")), e.textContent !== t && (pv(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
    ...
    Fe = function (e, t, n) {
     ...
     if (G && !W[t] && wv(L, t));
      ...
      if (
       !(
        (Ue(e) &&
         ((V.tagNameCheck instanceof RegExp && wv(V.tagNameCheck, e)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
         ((V.attributeNameCheck instanceof RegExp && wv(V.attributeNameCheck, t)) || (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
        ("is" === t && V.allowCustomizedBuiltInElements && ((V.tagNameCheck instanceof RegExp && wv(V.tagNameCheck, n)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(n))))
       )
      )
       return !1;
     } else if (ue[t]);
   ...
   return (
    (n.sanitize = function (e, r) {
     ...
     return (
      Q && z["!doctype"] && a.ownerDocument && a.ownerDocument.doctype && a.ownerDocument.doctype.name && wv(qv, a.ownerDocument.doctype.name) && (g = "<!DOCTYPE " + a.ownerDocument.doctype.name + ">\n" + g),
      X && ((g = vv(g, D, " ")), (g = vv(g, P, " "))),
  ...
  cy = (e, t, n) => {
   ...
   return (
    ...
    (!!/((java|vb)script|mhtml):/i.test(o) ||
     (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !j(dy, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
   );
  };
 class uy {
  constructor(e, t = {}) {
 ...
 const my = Tt.makeMap,
  fy = Tt.extend,
  gy = { IN_PLACE: !0, ALLOW_UNKNOWN_PROTOCOLS: !0, ALLOWED_TAGS: ["#comment", "#cdata-section", "body"], ALLOWED_ATTR: [] },
    ...
    n.addHook("uponSanitizeAttribute", (n, o) => {
     ...
     (o.keepAttr = !r || t.isValid(s, a) || ze(a, "data-") || ze(a, "aria-")),
      ...
      o.keepAttr
       ...
       : !n.hasAttribute(hy) || ("id" !== a && "class" !== a && "style" !== a) || (o.forceKeepAttr = !0);
    }),
    n
   );
  },
  ...
  Vy = (e, t, n) => {
   ...
   "fragmented" === t.type ? jy(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !su(o) || !o.isFakeCaret }), o && (e.selection.moveToBookmark(o), e.selection.scrollIntoView());
  },
    ...
    closest: (t) =>
     ((e, t) => {
      ...
      return M.from(e.selection.getStart(!0))
       .bind((o) => $h(mn(o), (n) => ce(t, (t) => ((t, n) => (Yh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n))
       .getOrNull();
     })(e, t),
      ...
      ((e, t, n, o, r, s) => {
       ...
       V(n.split(","), (t) => {
        const n = we(a, t).getOrThunk(() => {
         const e = { withSimilar: { state: Ca(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: Ca(!1), similar: !1, callbacks: [] }, withVars: [] };
         return (a[t] = e), e;
        }),
         i = () => {
          const n = Kb(e);
        ...
        Uh(t)
         ...
         : ((e, t, n, o) => {
          if (0 === n.length || /^\s+$/.test(n)) {
           ...
           const s = gl(e);
           return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, pl(e), n))) : n || (n = r), zh(e, n, o.no_selection), { content: n, html: n };
          }
          {
           "raw" !== o.format && (n = _g({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
      ...
      ((e, t) => {
       ...
       t.collapsed ||
        (n === o && s - r < 2 && n.hasChildNodes() && (a = n.childNodes[r]),
         zo(n) && zo(o) && ((n = n.length === r ? rg(n.nextSibling, !0) : n.parentNode), (o = 0 === s ? rg(o.previousSibling, !1) : o.parentNode), n && n === o && (a = n)));
 ...
 const UC = (e, t) => {
  ...
  zC = (e) => () => e.notificationManager.open({ text: e.translate("Image uploading..."), type: "info", timeout: -1, progressBar: !0 }),
           ...
           n.status && kl(e)
            ? (n.url && !Ue(l.src, n.url) && (s = !0),
             ...
             ((t, n) => {
              ...
              var r;
              d(t.src, n), qt(mn(t), { src: xl(e) ? ((r = n), r + (-1 === r.indexOf("?") ? "?" : "&") + new Date().getTime()) : n, "data-mce-src": o });
             })(l, n.url))
            : n.error &&
   ...
   const t = Na(),
    ...
    r = {
     ...
     dispatchChange: () => {
      e.setDirty(!0);
      const t = $y(e);
      (t.bookmark = $i(e.selection)), e.dispatch("change", { level: t, lastLevel: ae(r.data, o.get()).getOrUndefined() });
     },
      ...
      e.on("keyup", (n) => {
       ...
       n.isDefaultPrevented() ||
        (((s >= 33 && s <= 36) || (s >= 37 && s <= 40) || 45 === s || n.ctrlKey) && (r(), e.nodeChanged()),
         ...
         o.get() && t.typing && !Ky($y(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch("TypingUndo"), o.set(!1), e.nodeChanged()));
      }),
      e.on("keydown", (e) => {
       const s = e.keyCode;
          ...
          iw(e, n).map((n) =>
           ((e, t, n) =>
            Wo(n.position.getNode()) && !os(n.block)
             ? Xc(!1, n.block.dom)
              .bind((o) => (o.isEqual(n.position) ? Kc(t, e, o).bind((t) => iw(e, t)) : M.some(n)))
              .getOr(n)
             : n)(e, t, n)
          )
         )
    ...
    .fold(
     () =>
      ((e, t, n) => {
          ...
          : t && Vg(r) && op(s, r)
           ...
           : ((e, t, n) =>
            ((e, t) => {
             ...
             ? ((e, t) => (y(t) ? M.none() : e && Yo(t.nextSibling) ? M.some(Aw.moveToElement(t.nextSibling)) : !e && Yo(t.previousSibling) ? M.some(Aw.moveToElement(t.previousSibling)) : M.none()))(
              t,
              n.getNode(!t)
             ).orThunk(() => Ow(e, t, n))
             : Ow(e, t, n).bind((t) =>
       ...
       n.fold(
        ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), Bp(e, t, mn(n)), !0))(e, t),
        ((e, t) => (n) => {
 ...
 const mx = (e, t) => (e === Bc.Backwards ? ne(t) : t),
  ...
  px = (e, t, n, o) => {
   ...
   for (; s;) {
    const n = fx(t, r, s);
    if (!n) break;
    if (Wo(n.getNode(!1))) return t === Bc.Forwards ? { positions: mx(t, a).concat([n]), breakType: ux.Br, breakAt: M.some(n) } : { positions: mx(t, a), breakType: ux.Br, breakAt: M.some(n) };
    if (n.isVisible()) {
     if (e(s, n)) {
      const e = gx(0, t, s, n);
 ...
 const Bx = (e, t, n, o, r, s) => {
   ...
   if (e.selection.isCollapsed() && Xl(e)) {
    ...
    return ((e, t, n, o) => {
     const r = ((e, t) => vc(t, e) || e)(e.getBody(), o.container()),
      ...
      a = nx(s, r, o);
     return a
      .bind((e) => (n ? e.fold(N(M.some(ax(e))), M.none, N(M.some(sx(e))), M.none) : e.fold(M.none, N(M.some(sx(e))), M.none, N(M.some(ax(e))))))
      .map(ek(e, t))
      .getOrThunk(() => {
       const i = Gc(n, r, o),
        l = i.bind((e) => nx(s, r, e));
  ...
  eS = (e, t, n, o, r) => {
   const s = or(mn(n), "td,th,caption").map((e) => e.dom),
    a = K(
     ((e, t) =>
      ee(t, (t) => {
       const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(Ya(t.getBoundingClientRect()), -1);
       return [
  ...
  oS = (e, t, n) => {
   const o = e(t, n);
   return ((e) => e.breakType === ux.Wrap && 0 === e.positions.length)(o) || (!Wo(n.getNode()) && ((e) => e.breakType === ux.Br && 1 === e.positions.length)(o))
  ...
  pS = (e, t) => {
   ...
   return ((e, t) => ((e, t, n = P) => (n(t) ? M.none() : j(e, Lt(t)) ? M.some(t) : So(t, e.join(","), (e) => pn(e, "table") || n(e))))(["td", "th"], e, t))(mn(t ? s.endContainer : s.startContainer), r)
    .map(
     (n) => (
      Yk(n, r).each((t) => {
    ...
    () =>
     ((e, t, n, o = 0) => {
      ...
      return xS(
       ...
       const s = kS(r);
       return 0 !== s.lastIndexOf(n) || _S(s, n).length < o ? M.none() : M.some({ text: _S(s, n), range: r, trigger: n });
      });
     })(e, t, n, o),
    (t) => {
     const o = e.createRng();
 ...
 const TS = (e, t, n) => (e.stype === OS.Error ? t(e.serror) : n(e.svalue)),
   ...
   extract: (n, o) =>
    we(o, e).fold(
     ...
     (e) =>
      ((e, t, n, o) =>
       we(n, o).fold(
        () => ((e, t, n) => MS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + LS(t)))(e, n, o),
  ...
  YS = (e, t, n) => {
   return (o = ((e, t, n) => ((e, t) => (e.stype === OS.Error ? { stype: OS.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)), TS(o, Wi.error, Wi.value);
   var o;
  },
  XS = (e, t) => IS(e, ge(t, KS)),
  QS = N(VS),
 ...
 KS([E_("contextform"), g_("initValue", N("")), x_, ((e, t) => o_(e, e, { tag: "required", process: {} }, GS(t)))("commands", M_), l_("launch", XS("type", { contextformbutton: P_, contextformtogglebutton: L_ }))].concat(T_));
 const I_ = (e) => {
  ...
  tE = {
   insert: (e, t) => {
    ...
    if (("LI" !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && To(s) && i.isEmpty(w)))
  ...
  xE = (e, t, n) => {
   t.selection.isCollapsed() ||
    ...
    (C(n) && j_(t, e.fakeEventName).isDefaultPrevented()) || (e.insert(t, n), C(n) && z_(t, e.fakeEventName));
  },
  kE = (e, t) => {
   const n = () => xE(dE, e, t),
    o = () => xE(tE, e, t),
  ...
  OE = O(RE, " "),
  TE = (e, t) => (n) =>
   ((e, t) => !up(t) && (((e, t) => ((e, t) => Jc(e.dom, t).isNone())(e, t) || ((e, t) => Qc(e.dom, t).isNone())(e, t) || Qg(e, t) || Jg(e, t) || rp(e, t) || op(e, t))(e, t) || dp(e, t) || cp(e, t)))(e, n) ? AE(t) : OE(t),
  BE = (e) => {
   ...
   if (e.selection.isCollapsed()) {
    ...
    return nx(o, e.getBody(), r)
     ...
     .map((o) => () => TE(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)));
   }
   return M.none();
  },
  DE = (e) =>
 ...
 const ME = N("x-tinymce/html"),
  ...
  qE = (e) =>
   VE(e, [
    ...
    [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e, t, n) => (t || n ? tr : " ")],
  ...
  rN = (e, t, n) => {
   ...
   if (_d(e) && o) {
    ...
    if (s.length > 0)
     return (
      t.preventDefault(),
      ((r = s), Promise.all($(r, (e) => ey(e).then((t) => ({ file: e, uri: t }))))).then((t) => {
 ...
 const _N = (e, t) => Math.abs(e.left - t),
  ...
  ON = (e, t, n) =>
   ((e, t, n) => {
    ...
    .filter((e) => rc(e.node))
    .map((e) => ((e, t) => ({ node: e.node, position: _N(e, t) < EN(e, t) ? SN.Before : SN.After }))(e, t)),
  TN = (e) => {
   var t, n;
       ...
       !((e, t, n) => {
        const o = mn(e.getBody()),
         ...
         s = ((e, t, n, o) => {
          ...
          return { x: n - (e ? r.left + t.dom.clientLeft + SC(t) : 0), y: o - (e ? r.top + t.dom.clientTop + kC(t) : 0) };
         })(e.inline, r, t, n);
        return ((e, t, n) => {
         const o = wC(e),
          r = xC(e);
  ...
  XN = (e, t) => {
   const n = t.slice(),
    o = n.pop();
   return x(o) ? Y(n, (e, t) => e.bind((e) => M.from(e.childNodes[t])), M.some(e)).bind((e) => (zo(e) && (o < 0 || o > e.data.length) ? M.none() : M.some({ node: e, offset: o }))) : M.none();
  },
  QN = (e, t) =>
  ...
  ZN = (e, t, n, o = !0) => {
   ...
   t.deleteContents(),
    o &&
    !n(t.startContainer) &&
    (zo(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer), zo(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer), JN(e, r, n), r !== s && JN(e, s, n));
  },
  ...
  aR = (e, t, n) => {
   const o = QN(e.getRoot(), n).getOrDie("Unable to resolve path range"),
    ...
    l = i.parentNode;
   return { prefix: t, end: a.parentNode.insertBefore(rR(e, t + "-end"), a), start: l.insertBefore(rR(e, t + "-start"), i) };
  },
  iR = (e, t, n) => {
   ...
   return CS(i, l - n.pattern.end.length, t).bind((d) => {
    ...
    if (lR(a)) return M.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
    {
     ...
     return m.map((e) => {
      ...
      return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: hS(e.startContainer, e.startOffset) };
     });
    }
   });
  },
  ...
  fR = (e, t, n, o, r, s) => {
   ...
   return ((e, t) => {
    ...
    uR(e, ((a = r.inlinePatterns), se(a, (e, t) => t.end.length - e.end.length)), n, o, t, s).fold(
     () => [],
     (e) => e.matches
    )
   );
     ...
     const s = Math.max(0, n.startOffset),
      ...
      l = ((e, t, n, o) => {
       ...
       return ((e, t) => {
        ...
        .map((e) => (Tt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: YN(s, s.getRoot(), t, 0, t, 0, true) }]))
        .getOr([]);
      })(e, o, a);
     return (
  ...
  ER = (e) => {
   ...
   (o.disabled = !0),
    (e.readonly = dd(e)),
    e.readonly || (e.inline && "static" === vR.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
    (o.disabled = !1),
    (e.editorUpload = HC(e)),
    (e.schema = Qs(xR(e))),
    (e.dom = ba(n, {
     ...
     ((e) => {
      ((e) => {
       const t = [",", ".", ";", ":", "!", "?"],
        n = [32],
        o = () => {
         return (t = Ld(e)), (n = Md(e)), { inlinePatterns: Ji(t), blockPatterns: Qi(t), dynamicPatternsLookup: n };
         var t, n;
        },
    ...
    e.inline
     ...
     : ((e, t) => {
      ((e, t) => {
       ...
       (r.onload = () => {
        ...
        (e.iframeHTML = ((e) => {
         ...
         const n = cl(e),
          ...
          r = e.translate(bd(e));
         return (
          ml(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + ml(e) + '" />'),
       ...
       t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = RR.isHidden(t.editorContainer))),
  ...
  $R = (e, t) => ({ table_grid: !1, object_resizing: !1, resize: !1, toolbar_mode: we(e, "toolbar_mode").getOr("scrolling"), toolbar_sticky: !1, ...(t ? { menubar: !1 } : {}) }),
  VR = (e, t) => {
   var n;
   ...
   M.from(n)
    ...
    .bind((n) =>
     ((e, t, n) =>
      $h(
       mn(n),
       (t) => ((t) => Gn(t, e).orThunk(() => (XR(t) ? we(YR, e).bind((e) => Kt(t, e)) : M.none())))(t),
       (e) => bn(mn(t), e)
     ...
     ((e) => {
      ...
      ((e) => {
       ...
       e.editorCommands.addCommands({ "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": (e) => t(e), mceBlockQuote: () => t("blockquote") }, "state"),
        e.editorCommands.addQueryValueHandler("FontName", () => ((e) => tA(e, (t) => ZR(e.getBody(), t.dom)).getOr(""))(e)),
        e.editorCommands.addQueryValueHandler("FontSize", () => ((e) => tA(e, (t) => JR(e.getBody(), t.dom)).getOr(""))(e)),
 ...
 const wA = (e, t) => {
    ...
    "focus" !== e &&
     ...
     (n.removed ||
      (t
       ...
       : n.initialized && n.delegates && (n.dom.unbind(wA(n, e), e, n.delegates[e]), delete n.delegates[e])));
   },
  ...
  _A = (e) => (m(e) ? { value: e.split(/[ ,]/), valid: !0 } : k(e, m) ? { value: e, valid: !0 } : { valid: !1, message: "The value must be a string[] or a comma/space separated string." }),
  ...
  TA = Tt.each,
  BA = Tt.explode,
  DA = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
 ...
 class jA {
  constructor(e, t, n) {
   ...
   (this.options = ((e, t) => {
    ...
    ((e) => {
     ...
     t("id", { processor: "string", default: e.id }),
      ...
      t("language", { processor: "string", default: "es" }),
      ...
      t("text_patterns", {
       processor: (e) => (k(e, f) || !1 === e ? { value: Zi(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." }),
       default: [
      ...
      t("noneditable_regexp", { processor: (e) => (k(e, ol) ? { value: e, valid: !0 } : ol(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }), default: [] }),
      t("table_tab_navigation", { processor: "boolean", default: !0 }),
      e.on("ScriptsLoaded", () => {
       t("directionality", { processor: "string", default: Sa.isRtl() ? "rtl" : void 0 }), t("placeholder", { processor: "string", default: nl.getAttrib(e.getElement(), "placeholder") });
      });
    })(o);
   ...
   c && (Nt.cacheSuffix = c.replace(/^[\?\&]+/, "")),
    (this.ui = { registry: IA(), styleSheetLoader: void 0, show: S, hide: S, setEnabled: S, isEnabled: L }),
    (this.mode = ((e) => {
     const t = Ca("design"),
      n = Ca({ design: { activate: S, deactivate: S, editorReadOnly: !1 }, readonly: { activate: S, deactivate: S, editorReadOnly: !0 } });
     return (
      ((e) => {
       e.serializer
        ? fA(e)
  ...
  render() {
   ((e) => {
    ...
    e.on("remove", () => {
     ...
     (e.ui.styleSheetLoader = ((e, t) => ws.forElement(e, { contentCssCors: cd(t), referrerPolicy: Tl(t) }))(o, e)),
     nd(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = "hidden"));
    const s = e.getElement().form || DR.getParent(t, "form");
    s &&
     ((e.formElement = s),
      od(e) && !Uo(e.getElement()) && (DR.insertAfter(DR.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
      ...
      !rd(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || ((s._mceOldSubmit = s.submit), (s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s))))),
  ...
  hide() {
   ...
   e.hidden ||
    (e.save(),
     e.inline ? ((e.getBody().contentEditable = "false"), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (FA.hide(e.getContainer()), FA.setStyle(e.id, "display", e.orgDisplay)),
     (e.hidden = !0),
     e.dispatch("hide"));
  }
  isHidden() {
  ...
  destroy(e) {
   ((e, t) => {
    ...
    e.destroyed ||
     (t || e.removed
      ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), hC(n), hC(o)),
       ((e) => {
      ...
      (i = ((e, t) => {
       ...
       ((e) =>
        Nt.browser.isIE() || Nt.browser.isEdge()
         ? (DC("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers"), [])
         : XA
          ? (DC("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [])
          : m(e.selector)
 ...
 const iO = {
  ...
  dom: { EventUtils: ia, TreeWalker: Ro, TextSeeker: Ka, DOMUtils: ba, ScriptLoader: ya, RangeUtils: mf, Serializer: dC, StyleSheetLoader: Cs, ControlSelection: Fm, BookmarkManager: _m, Selection: aC, Event: ia.Event },
...
!(function () {
 ...
 var n,
  ...
  S = { mceEditImage: "imagetools_open_dialog", mceImageRotateLeft: "imagetools_rotate", mceImageRotateRight: "imagetools_rotate", mceImageFlipVertical: "imagetools_flip", mceImageFlipHorizontal: "imagetools_flip" },
  h = { InsertUnorderedList: !0, InsertOrderedList: !0 },
  I = { mceInsertTemplate: "template_insert", mceInsertDate: "insertdatetime_insert", mceInsertTime: "insertdatetime_insert", mcePreview: "preview_open_dialog", mceAnchor: "anchor_open_dialog" },
  w = function (t) {
