...
// $queryBD = mysqli_query($conn3,"SELECT baseDatos FROM  usuarios WHERE ID =$_SESSION[ID]");
...
$connMedical = mysqli_connect('localhost', 'medicaso_rootBase', '5qA?o]t6d-h25qA?o]t6d-h2', 'medicaso_ms_do1334');
// recibir el post
