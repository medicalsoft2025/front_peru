...
<body>
    ...
    <div class="fila-informacion">
        ...
        <div class="info-factura">
            <div class="titulo-factura">COMPROBANTE CONTABLE</div>
            <div class="detalle-info"><strong>Saldos iniciales No. </strong>32131231</div>
    ...
    <!-- Concepto -->
    <div class="concepto">
        <strong>DETALLE:</strong> Venta de mercancías
    </div>
