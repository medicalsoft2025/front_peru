...
<body>
    ...
    <div class="fila-informacion">
        ...
        <div class="info-factura">
            <div class="titulo-factura">NOTA DE CREDITO</div>
            <div class="detalle-info">e-NCF: [Código e-NCF]</div>
        </div>
    </div>
    ...
    <div>
        <p><strong>Razón social Cliente: </strong>Comercio, SRL</p>
        <p><strong>RNC Cliente: </strong>123456789</p>
    </div>
    ...
    <div class="seccion-final">
        ...
        <div class="totales">
            ...
            <div class="fila-total">
                ...
                <div class="valor-total">180.00</div>
            </div>
            <div class="fila-total">
