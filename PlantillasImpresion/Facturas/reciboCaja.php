...
<body>
    ...
    $fechaEmision = date("d/m/Y H:i:s"); // Fecha con hora

    // Variables del recibo
    $numeroRecibo = "RC-001-2023";
    ...
    // Objeto para la liquidación
    $liquidacion = [
        "valor_parcial" => 2000.00,
        "iva_liquidado" => 360.00,
        "valor_total" => 2360.00,
        "porcentaje_iva" => 18
    ];
    ...
    <div class="fila-informacion">
        ...
        <!-- Bloque derecho - Información del recibo -->
        <div class="info-factura">
            <div class="titulo-factura"><?php echo $tituloDocumento; ?></div>
            <div class="detalle-info">No. <?php echo $numeroRecibo; ?></div>
    ...
    <div class="datos-cliente">
        ...
        <p><strong>Identificación:</strong> <?php echo $identificacionCliente; ?></p>
    ...
    <!-- Concepto -->
    <div class="concepto">
        <strong>Por concepto de:</strong> <?php echo $concepto; ?>
        <?php foreach ($productos as $producto):
            echo "<br>" . $producto['descripcion'] . " - Cantidad: " . $producto['cantidad'] . " - Unidad: " . $producto['unidad'] . " - Precio: $" . number_format($producto['precio'], 2);
        endforeach; ?>
    </div>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>Valor parcial</td>
                <td><?php echo number_format($liquidacion['valor_parcial'], 2); ?></td>
                <td>-</td>
                <td><?php echo number_format($liquidacion['valor_parcial'], 2); ?></td>
            </tr>
            <tr>
                <td>IVA liquidado</td>
                <td><?php echo number_format($liquidacion['valor_parcial'], 2); ?></td>
                <td><?php echo $liquidacion['porcentaje_iva']; ?>%</td>
                <td><?php echo number_format($liquidacion['iva_liquidado'], 2); ?></td>
            </tr>
            <tr>
                <td><strong>Valor total</strong></td>
                <td>-</td>
                <td>-</td>
                <td><strong><?php echo number_format($liquidacion['valor_total'], 2); ?></strong></td>
            </tr>
        </tbody>
    </table>
