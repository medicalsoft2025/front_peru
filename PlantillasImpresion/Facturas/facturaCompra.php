...
<head>
    ...
    <style>
        /* [Mantén todos los estilos CSS anteriores] */
        body {
...
<body>
    ...
    <div class="fila-informacion">
        ...
        <div class="info-factura">
            <div class="titulo-factura">FACTURA DE COMPRA</div>
            <div class="detalle-info">e-NCF: <?php echo $enfc; ?></div>
            <!-- <div class="detalle-info">No.: <?php echo $numeroFactura; ?></div> -->
        </div>
    </div>
