...
include "./NuevaRetencionModal.php";
?>
<div class="modal fade" id="modalNewInvoicePurchase" tabindex="-1" aria-labelledby="scrollingLongModalLabel2" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="scrollingLongModalLabel2">Nueva Factura de Compra</h5><button class="btn btn-close p-1" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-2">
                                    ...
                                    <input class="form-control" id="price" type="number" placeholder="10.000" disabled>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-2">
                                    ...
                                    <div class="col p-2">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="row g-3">
                                                    <div class="col-sm-3 col-md-6 col-lg-12">
                                                        <button class="btn btn-info w-100 rounded-pill" type="button" id="modalNewRetentionButton"> Agregar Retenciones
                                                        </button>
                                                    </div>
                                                    <div class="col-sm-3 col-md-6 col-lg-12">
                                                        <label class="form-label" for="remaining">Restante por pagar</label>
                                                        <input class="form-control" id="remaining" type="input" disabled>
                                                    </div>
                                                    <div class="col-sm-3 col-md-6 col-lg-12">
...
<script>
    document.getElementById('modalNewRetentionButton').addEventListener('click', function() {
        var myModal = new bootstrap.Modal(document.getElementById('modalNewRetention'));
        myModal.show();
    });
</script>