                                            ...
                                            <table class="table table-sm fs-9 mb-0 tableDataTableSearch">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sort border-top custom-th" data-sort="fecha_consulta">Fecha Consulta</th>
                                                        <th class="sort border-top custom-th" data-sort="profesiona">Profesional asignado</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle white-space-nowrap pe-0 p-3">
                                                                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                                                    <button class="btn btn-outline-primary me-1 mb-1 rounded-pill" type="button" data-bs-toggle="modal" data-bs-target="#modalAdmision"><i class="fas fa-file-invoice success"></i> Generar admisión </button>
