...
function procesarDescuento($configuracionUsuario, $minutosRetardo, $salarioEmpleado, $salarioMinimo, $idTrabajador, $idUsuario, $tipoDescuento) {
    ...
    // echo "Desde funcion procesarDescuento";

    if ($tipoDescuento == 'inasistencia' && $esInasistencia && $configuracionUsuario['aplicaDescuentoInasistencia'] != 'No') {
        // echo "Se fue por el if de inasistencia";
        // echo "descuentoInasistenciaSegun => " . $configuracionUsuario['descuentoInasistenciaSegun'];
        // echo "valorDescuentoInasistencia => " . intval($configuracionUsuario['valorDescuentoInasistencia']); 
        ...
        // echo "Se fue por el else de retardo";
        // echo "descuentoRetardoSegun => " .$configuracionUsuario['descuentoRetardoSegun'];
        // echo "valorDescuentoRetardo => " .intval($configuracionUsuario['valorDescuentoRetardo']);
        // echo "salarioEmpleado => " .$salarioEmpleado;
        // echo "salarioMinimo => " .$salarioMinimo;
        // die();
...
// include "../Models/Nomina/Marcaje.php";
// include "../Controllers/Nomina/Marcaje.php";

// include "../Models/Nomina/Descuentos.php";
// include "../Controllers/Nomina/Descuentos.php";

// include "../Models/Nomina/Configuracion.php";
// include "../Controllers/Nomina/Configuracion.php";
