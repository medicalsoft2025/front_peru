...
require_once "./../funciones/funcionesModels.php"; // NECESARIO PARA ALGUNAS UTILIDADES DE LOS MODELS
...
$ConfigNominaUser = $ControllerConfiguracion->obtenerPorCondicion(" AND idUsuario = " . $idUsuario);
...
<body>
                ...
                <div id="step-contrato-<?= $indice ?>">
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                            ...
                            <h6>&</h6>
                            <img src="<?= $ConfigNominaUser["logoBase64"] ?>" style="width: 50%;">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 row">
                        <div class="col-md-6">
                            ...
                            <p>En esta sección, te invitamos a revisar detenidamente el contrato que se te presenta. Es fundamental que comprendas todos los términos y condiciones establecidos, ya que este documento formaliza tu relación con nuestra empresa. Asegúrate de prestar especial atención a las cláusulas relacionadas con tus derechos y obligaciones, así como a cualquier información pertinente sobre tu rol y beneficios.<br><br>
                                ...
                                <a style="text-decoration: none;" class="text-primary" data-bs-toggle="modal" data-bs-target="#modalVistaContrato"><i class="fas fa-eye"></i>&nbsp;Ver contrato</a>
                                <a class="" target="_blank" href="https://erp.medicalsoftplus.com/FE/Contrato/descargar.php?i=<?= base64_encode($idContrato) ?>"><i class="fas fa-file-arrow-down"></i>&nbsp;Descargar contrato</a><br>
                            </p>
    ...
    <div class="modal fade" id="modalVistaContrato" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Contrato #<?= str_pad($idContrato, 8, "0", STR_PAD_LEFT) ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <?= $datosContrato["contenidoContrato"] ?>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"> <i class="fas fa-thumbs-up"></i> &nbsp;Entiendo</button>
                </div>
            </div>
        </div>
    </div>
