...
$reportes = [
    ['icono' => 'chart-line', 'titulo' => '606 compras', 'texto' => 'Visualiza ingresos, costos y gastos del periodo', 'url' => 'Report606Purchases'],
    ['icono' => 'balance-scale', 'titulo' => '607 ventas', 'texto' => 'Activos, pasivos y patrimonio de la empresa', 'url' => 'Report607Sales'],
];
?>
<style>
    .componente {
        ...
        <div class="container-small">
            <nav class="mb-4" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Reportes Fiscales</li>
                </ol>
            </nav>
