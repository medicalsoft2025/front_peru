<?php 
class ProcedimientosEntidadController {
    private $model;

    public function __construct($db, $data = []) {
        $this->model = new ProcedimientoEntidadModel($db);
    }
    ...
    public function index($condicion = "") {
        $respuesta = $this->model->obtener($condicion);
        return $respuesta;
    }
    ...
    public function obtenerPorEntidad($entidadId) {
        $respuesta = $this->model->obtenerPorCondicion(" AND idEntidad = '{$entidadId}'");
        return $respuesta;
    }
