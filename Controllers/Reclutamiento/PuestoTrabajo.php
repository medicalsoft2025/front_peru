...
class PuestosTrabajoController {
    private $model;

    public function __construct($db) {
        $this->model = new PuestoTrabajoModel($db);
    }
    ...
    public function obtenerPorUsuarioyActivos($idUsuario) {
        $respuesta = $this->model->obtenerPorCondicion(" AND idUsuario = " . $idUsuario . " AND estadoPublicado='Publicado'");
        $respuesta = $respuesta == null || $respuesta == false ? [] : $respuesta;
        return $respuesta;
    }
