...
class CalculoIncapacidadController {
    private $model;

    public function __construct($db) {
        $this->model = new CalculoIncapacidadModel($db);
    }
    ...
    public function obtenerPorMoneda($moneda) {
        $respuesta = $this->model->obtenerPorCondicion(" AND moneda = '" . $moneda . "' ");
        $respuesta = is_array($respuesta) ? $respuesta[0] : [];
        return $respuesta;
    }
