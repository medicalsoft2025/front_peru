...
$idReciboPago = base64_decode($_GET['id']);
$idUsuario = base64_decode($_GET['idU']);


$ControllerReciboPago = new RecibosPagoController($conn3);
$datosRecibo = $ControllerReciboPago->obtenerPorId($idReciboPago);
...
try { ?>
    ...
    <center>
        <div class="content-detalle-individual">
            <h4 class="text-center">Recibo de pago</h4>
                    ...
                    <div class="col-5 text-end">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td><?= str_pad($idReciboPago, 6, "0", STR_PAD_LEFT); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
