        ...
        <div class="row g-0 g-md-4 g-xl-6">
          ...
          <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="lead-details-container">
              <nav class="navbar pb-4 px-0 sticky-top bg-body" id="navbar-deals-detail">
                <ul class="nav nav-underline fs-9" role="tablist">
                  <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" role="tab" aria-selected="true"
                      onclick="showSections('content-masivos-dashboard')">Dashboard</a></li>
                  <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                      onclick="showSections('content-masivos-reclutamiento')">Reclutamiento</a></li>
                  <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                      onclick="showSections('content-masivos-nomina')">Nomina</a></li>
                  <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                      onclick="showSections('content-masivos-cgenerales')">Generales</a></li>
                </ul>
              </nav>
                      ...
                      <div class="card-body">
                        <div class="d-flex justify-content-evenly">
                          ...
                          foreach ($datosEstadisticas as $estadistica) { ?>
                            <div class="col-6 col-md-4 col-xxl-2 border text-center p-3">
                            ...
                            <ul class="nav flex-column nav-underline fs-9" id="myTab" role="tablist">
                              ...
                              <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" role="tab" aria-selected="true"
                                  onclick="showSubSections('content-masivos-reclutamiento','sub-content-apertura', <?= $array_subsecciones ?>)">Puestos</a>
                              </li>
                              <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                                  onclick="showSubSections('content-masivos-reclutamiento','sub-content-candidatos', <?= $array_subsecciones ?>)">Postulaciones
                                  / Candidatos</a>
                              </li>
                              <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                                  onclick="showSubSections('content-masivos-reclutamiento','sub-content-entrevistas', <?= $array_subsecciones ?>)">Entrevistas</a>
                              </li>
                              <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="true"
                                  onclick="showSubSections('content-masivos-reclutamiento','sub-content-contratos', <?= $array_subsecciones ?>)">Contratos</a>
                              </li>
                            </ul>
                          </div>
                          <div class="col-md-10">
                            <div class="col-md-12 d-flex flex-row-reverse gap-3 mb-3">
                              <div class="p-0">
                                <button class="btn btn-info btn-sm" onclick="window.open('<?= $urlWeb ?>', '_blank')"
                                  type="button">
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#modalReclutamientoPuesto">Puesto de trabajo</a></li>
                                    <!-- <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalReclutamientoCandidato">Candidatos</a></li> -->
                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#modalEntrevista">Entrevista</a></li>
                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#modalReclutamientoPromocion">Promocion</a></li>
                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#modalNuevoContrato">Contrato</a></li>
                                  </ul>
                                </div>
                              </div>
                      ...
                      <div class="col-md-12 row">
                          ...
                          <nav class="navbar pb-4 px-0 sticky-top bg-body nav-underline-scrollspy"
                            ...
                            <ul class="nav nav-underline fs-9" role="tablist">
                              ...
                              <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-nomina','sub-content-trabajadores', <?= $array_subsecciones_nomina ?>)">Trabajadores</a>
                              </li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-nomina','sub-content-liquidacionesnomina', <?= $array_subsecciones_nomina ?>)">Liquidaciones
                                  Nomina</a></li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-nomina','sub-content-liquidacionestrabajadores', <?= $array_subsecciones_nomina ?>)">Liquidaciones
                                  Trabajadores</a></li>
                            </ul>
                          </nav>
                        </div>
                        <div class="col-md-4 row text-end">
                          ...
                          <div class="col-md-5 p-1">
                            <button class="btn btn-info btn-sm" onclick="window.open('<?= $urlTimer ?>', '_blank')"
                              type="button"><i class="fas fa-clock"></i>&nbsp;Marcaje</button>
                          </div>

                          <div class="col-md-3 p-1">
                            <div class="dropdown">
                              <button class="btn btn-primary btn-sm dropdown-toggle" type="button"
                                id="dropdownMenuNomina" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-plus"></i> &nbsp; Nuevo
                              </button>
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuNomina">
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalNuevoTrabajador">Trabajador</a></li>
                                <!-- <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalNuevoContrato">Contrato</a></li> -->
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalNuevaLiquidacionNomina">Liquidacion de Nomina</a></li>
                              </ul>
                            </div>
                      ...
                      <div class="row gx-3">
                        <div class="col-12 row mb-3">
                                ...
                                foreach ($camposGenerales as $label => $datos) { ?>
                                  <div class="col-md-4 mb-1">
                                    <label class="mb-0"><?= $label ?>
                                      <?= (($datos[3] == 'required') ? '<span class="text-primary">*</span>' : ('')) ?></label>
                                    <?php if ($datos[0] == "select") {
                                      //select2
                                      ?>
                                      <!-- onchange="changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true)" -->
                                      <select class="form-select elementsConfigNomina" style="width: 100%;"
                                        id="<?= $datos[1] ?>">
                                        <?php
                                    ...
                                    <?php } else if ($datos[0] == "input") { ?>
                                        <!-- onchange="changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true)" -->
                                        <input value="<?= $datos[4] ?>" class="form-control elementsConfigNomina"
                                          type="<?= $datos[2] ?>" <?= $datos[3] ?> id="<?= $datos[1] ?>"
                                          placeholder="<?= $label ?>" />
                                    <?php } ?>
                                  </div>
                                <?php } ?>
                            ...
                            <div id="subcontenedor-seccion-cg-3">
                              <div class="col-md-12 row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <select class="form-select elementsConfigNomina" id="aplicaDescuentoRetardo"
                                    onchange="$('.divsRetardos').css('display', this.value == 'Si' ? 'block' : 'none'); ">
                                ...
                                <div class="divsRetardos col-md-4" style="display:none">
                                  ...
                                  <!-- changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true) -->
                                  <input type="number" class="form-control elementsConfigNomina"
                                    onchange="this.value > 60 ? this.value = 60 : this.value;"
                                    id="minutosMargenRetardo">
                                </div>

                                <div class="divsRetardos col-md-4" style="display:none">
                                  <label for="">Aplicar descuento segun</label>
                                  <!-- changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true) -->
                                  <select class="form-select elementsConfigNomina" id="descuentoRetardoSegun"
                                    onchange="setValorDescuentoRetardo(this.value);">
                                ...
                                <div class="divsRetardos col-md-4" style="display:none">
                                  ...
                                  <!-- changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true)" -->
                                  <input type="number" class="form-control elementsConfigNomina"
                                    id="valorDescuentoRetardo"
                                    onchange="this.value > this.max ? this.value = this.max : this.value;">
                                </div>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <!-- changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true)" -->
                                  <select class="form-select elementsConfigNomina" id="aplicaDescuentoInasistencia"
                                    onchange="$('.divsInasistencias').css('display', this.value == 'Si' ? 'block' : 'none');">
                                    <option value="No">No</option>
                                    <option value="Si">Si</option>
                                    <option value="Manual">Especificar al liquidar nomina</option>
                                  </select>
                                ...
                                <div class="divsInasistencias col-md-4" style="display:none">
                                  ...
                                  <input type="number" class="form-control elementsConfigNomina"
                                    onchange="this.value > 60 ? this.value = 60 : this.value;"
                                    id="minutosMargenInasistencia">
                                </div>

                                <div class="divsInasistencias col-md-4" style="display:none">
                                  <label for="">Aplicar descuento segun</label>
                                  <!-- changeAjaxFast('configNomina', this.id, this.value, 'idUsuario' , '<?= $_SESSION['ID'] ?>' , true)" -->
                                  <select class="form-select elementsConfigNomina" id="descuentoInasistenciaSegun"
                                    onchange="setValorDescuentoInasistencia(this.value);">
                                    <option value="salarioTrabajador">Salario del Trabajador</option>
                                    <option value="salarioMinimo">Salario Minimo</option>
                                    <option value="montoFijo">Monto fijo</option>
                                  </select>
                          ...
                          <div class="col-3"
                            ...
                            <h5> Logo</h5>
                            <small>(png)</small>
                            <img id="logoImage" class="profile-pic" src="https://via.placeholder.com/150"
                            ...
                            <div class="upload-btn-wrapper">
                              <button data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Con el fin de obtener una mejor visualizacion en el entorno web y vistas de impresion se recomienda cargar una imagen con fondo transparente"
                        ...
                        <div class="col-md-12 row">
                          <div class="col-md-9">
                            ...
                            <ul class="nav nav-underline fs-9 mt-4 mb-3" role="tablist">
                              ...
                              <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-sedes', <?= $array_subsecciones_generales ?>)">Sedes</a>
                              </li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-tiposrecargos', <?= $array_subsecciones_generales ?>)">Tipos
                                  de Recargos</a></li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-cargos', <?= $array_subsecciones_generales ?>)">Cargos</a>
                              </li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-retencionessalario', <?= $array_subsecciones_generales ?>)">Retenciones
                                  Salario</a></li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-deduccionesgrupales', <?= $array_subsecciones_generales ?>)">Deducciones</a>
                              </li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-adicionesgrupales', <?= $array_subsecciones_generales ?>)">Provisiones</a>
                              </li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-estados', <?= $array_subsecciones_generales ?>)">Estados
                                  de reclutamiento</a></li>
                              <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" role="tab"
                                  aria-selected="true"
                                  onclick="showSubSections('content-masivos-cgenerales','sub-content-plantillasc', <?= $array_subsecciones_generales ?>)">Plantillas
                                  de contrato</a></li>
                            </ul>
                          </div>
                          <div class="col-md-3">
                            <div class="dropdown">
                              <button class="btn btn-primary btn-sm dropdown-toggle" type="button"
                                id="dropdownMenuSeccionGeneral" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-plus"></i> &nbsp; Nuevo
                              </button>
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuSeccionGeneral">
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalNuevaSede">Sede</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalTiposRecargo">Tipo de recargo</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalNuevoCargo">Tipo de cargo</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalRetencionSalarial">Retencion de salario</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalDeduccionesGrupales">Deducciones</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalAdicionesGrupales">Provisiones</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalNuevoEstado">Estado de reclutamiento</a></li>
                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modalPlantillaContrato">Plantilla de Contrato</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
