<?php 
    ...
    include "../../Models/Reclutamiento/EstadosReclutamiento.php";
    include "../../Controllers/Reclutamiento/EstadosReclutamiento.php";


    try {
        $Controller = new EstadoReclutamientoController($conn3);
        $name = "Estado de reclutamiento";
