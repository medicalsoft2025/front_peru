<?php 
    ...
    include "../../Models/Nomina/Liquidaciones.php";
    include "../../Controllers/Nomina/Liquidaciones.php";
    
    include "../../Models/Nomina/Trabajadores.php";
    include "../../Controllers/Nomina/Trabajadores.php";

    try {
        $Controller = new LiquidacionesController($conn3);
        ...
        if ($action == "crear") {
            ...
            if ($Crear["status"] == true) {
                ...
                $ControllerTrabajadores->editar($_POST["idTrabajador"], ["activo" => "0"]);
