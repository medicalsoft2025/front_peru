...
dwvjq.gui.UrlLoad = function (app) {
  ...
  function onchangeinternal(event) {
    ...
    var Numero = document.getElementById("cliente_id").value;
    var Nombre = document.getElementById("Nombre").value;
    var AutorizacionState = document.getElementById("AutorizacionState").value;
    if(Numero!="" && Nombre!="" && AutorizacionState!="" )
    {
      app.loadURLs([enlaceBase + "ArchivosDicom/"+Numero+"/"+Nombre+"/state_dicom.json"]);
      alert("Se Cargaron las Ediciones de "+Numero);

      //  app.loadURLs(["https://medicalsoftplus.com/baseDev/ArchivosDicom/"+Numero+"/"+Nombre+"/state_dicom.json"]);
      // alert("Se Cargaron las Ediciones de "+Numero);
    }
    else{
