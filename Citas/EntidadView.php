                ...
                <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                    <div class="card-header bg-body-highlight pt-3 pb-2 border-bottom-0">
                        <ul class="nav justify-content-between nav-wizard nav-wizard-success" role="tablist">
                            <li class="nav-item" role="presentation"><a class="nav-link active fw-semibold"
                                    href="#bootstrap-wizard-validation-tab1" data-bs-toggle="tab" data-wizard-step="1"
                                            ...
                                            <span class="nav-item-circle d-flex">
                                                <svg class="svg-inline--fa fa-user" aria-hidden="true" focusable="false"
                                                    ...
                                                    <path fill="currentColor"
                                                        d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm0 32c-70.7 0-128 57.3-128 128v16c0 17.7 14.3 32 32 32h192c17.7 0 32-14.3 32-32v-16c0-70.7-57.3-128-128-128z">
                                                    </path>
                                                </svg>
                                            </span></span><span class="d-none d-md-block mt-1 fs-9">Información
                                            básica</span></div>
                                </a></li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link fw-semibold" href="#bootstrap-wizard-validation-tab2"
                                    data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1"
                                    role="tab">
                                    <div class="text-center d-inline-block">
                                        <span class="nav-item-circle-parent">
                                            <span class="nav-item-circle d-flex">
                                                <svg class="svg-inline--fa fa-file-invoice" aria-hidden="true"
                                                    focusable="false" data-prefix="fas" data-icon="file-invoice"
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link fw-semibold"
                                    ...
                                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span
                                            ...
                                            class="d-none d-md-block mt-1 fs-9">Hecho</span></div>
                                </a></li>
                        </ul>
                    </div>
                    <div class="card-body pt-4 pb-0">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" role="tabpanel"
                                ...
                                <form class="needs-validation was-validated" id="wizardValidationForm1"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-wizard-seller">Vendedor*</label>
                                                        <input class="form-control" type="text" name="seller"
                                                            placeholder="Vendedor" required="required"
                                                            id="bootstrap-wizard-validation-wizard-seller"
                                                            data-wizard-seller="true">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-wizard-date-preparation">Fecha
                                                            de elaboración*</label>
                                                        <input class="form-control" type="date" name="date-preparation"
                                                            placeholder="Fecha de elaboración" required="required"
                                                            id="bootstrap-wizard-validation-wizard-date-preparation"
                                                            data-wizard-date-preparation="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-wizard-date-expiry">Fecha
                                                            de vencimiento*</label>
                                                        <input class="form-control" type="date" name="date-expiry"
                                                            placeholder="Fecha de vencimiento" required="required"
                                                            id="bootstrap-wizard-validation-wizard-date-expiry"
                                                            data-wizard-date-expiry="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-entity">Entidad</label>
                                                        <select class="form-select" name="entity"
                                                            id="bootstrap-wizard-validation-entity">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-wizard-authorisation-number">Número
                                                            de Autorizacion*</label>
                                                        <input class="form-control" type="number"
                                                            name="authorisation-number"
                                                            placeholder="úmero de Autorizacion" required="required"
                                                            id="bootstrap-wizard-validation-wizard-authorisation-number"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-entity">Centro de
                                                            costo</label>
                                                        <select class="form-select" name="entity"
                                                            id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-procedure">Procedimiento</label>
                                                        <input class="form-control" type="text" name="procedure"
                                                            placeholder="Procedimiento" id="procedure"
                                                            required="required">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-entity">Especialista</label>
                                                        <select class="form-select" name="entity"
                                                            id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body"
                                                            for="bootstrap-wizard-validation-wizard-date-expiry">Paciente*</label>
                                                        <input class="form-control" type="text" name="date-expiry"
                                                            placeholder="Fecha de vencimiento" required="required"
                                                            id="bootstrap-wizard-validation-wizard-date-expiry"
                                                            data-wizard-date-expiry="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label" for="start-date-procedure">Fecha de
                                                            Inicio - Procedimiento*</label>
                                                        <input class="form-control datetimepicker flatpickr-input"
                                                            name="start-date-procedure" id="start-date-procedure"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-2">
                                                        <label class="form-label" for="seller">Fecha Fin -
                                                            Procedimiento*</label>
                                                        <input class="form-control datetimepicker flatpickr-input"
                                                            name="date-end-procedure" id="date-end-procedure"
                                                            type="text" placeholder="dd/mm/yyyy"
                                                            data-options="{&quot;disableMobile&quot;:true,&quot;dateFormat&quot;:&quot;d/m/Y&quot;}"
                                                            readonly="readonly" required="required">
                                ...
                                <div class="card">
                                    <div id="tableExample3"
                                        ...
                                        <div class="d-flex justify-content-between mt-3"><span
                                                class="d-none d-sm-inline-block" data-list-info="data-list-info">1 to 5
                                                <span class="text-body-tertiary"> Items of </span>43</span>
                                            <div class="d-flex"><button class="page-link disabled"
                                                ...
                                                <ul class="mb-0 pagination">
                                                    ...
                                                    <li><button class="page" type="button" data-i="3"
                                                            data-page="5">3</button></li>
                                                    <li class="disabled"><button class="page" type="button">...</button>
                                                    </li>
                                                            ...
                                                            <table class="table">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th scope="col" class="small">Método de Pago
                                                                        </th>
                                                                        <th scope="col" class="small">Valor</th>
                                                                        <th scope="col" class="small">N° de Comprobante
                                                                        </th>
                                                                        <th scope="col" class="small"></th>
                                                                    </tr>
                                                                </thead>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row g-3">
                                                                <div class="col-sm-3 col-md-6 col-lg-12">
                                                                    <label class="form-label" for="methodPayment">Método
                                                                        de pago</label>
                                                                ...
                                                                <div class="col-sm-3 col-md-6 col-lg-12">
                                                                    <label class="form-label" for="amount">N° de
                                                                        Comprobante</label>
                                                                    <input class="form-control" id="amount"
                                                                        type="number">
                                                                </div>
                                                            ...
                                                            <div class="px-0">
                                                                <div class="table-responsive scrollbar">
                                                                    <table class="table fs-9 text-body mb-0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="fw-semibold text-start">Total
                                                                                    Facturado</td>
                                ...
                                <div class="row flex-center pb-8 pt-4 gx-3 gy-4">
                                    <div class="col-12 col-sm-auto">
                                        <div class="text-center text-sm-start">
                                            ...
                                            <p class="text-body-emphasis fs-9">La admisión medica a sido completada
                                                exitosamente </p>
                                            <!-- <a class="btn btn-primary px-6" href="../../modules/forms/wizard.html">Acciones</a> -->
                    ...
                    <div class="card-footer border-top-0" data-wizard-footer="data-wizard-footer">
                        <div class="d-flex pager wizard list-inline mb-0"><button class="d-none btn btn-link ps-0"
                                type="button" data-wizard-prev-btn="data-wizard-prev-btn"><svg
                                    class="svg-inline--fa fa-chevron-left me-1" data-fa-transform="shrink-3"
                                ...
                                <!-- <span class="fas fa-chevron-left me-1" data-fa-transform="shrink-3"></span> Font Awesome fontawesome.com -->Anterior</button>
                            <div class="flex-1 text-end"><button class="btn btn-primary px-6 px-sm-6" type="submit"
                                    data-wizard-next-btn="data-wizard-next-btn">Siguiente<svg
                                        class="svg-inline--fa fa-chevron-right ms-1" data-fa-transform="shrink-3"
