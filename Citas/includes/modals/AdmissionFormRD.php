                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    ...
                                                    <select class="form-select" name="typeDocumentPatient" id="typeDocumentPatient" readonly disabled>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input class="form-control" type="number" name="numberIdentificationPatient" id="numberIdentificationPatient" readonly disabled>
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    ...
                                                    <input class="form-control datetimepicker flatpickr-input" id="dateBirthPatient" name="dateBirthPatient" type="text" placeholder="dd/mm/yyyy" readonly disabled data-options="{&quot;disableMobile&quot;:true,&quot;dateFormat&quot;:&quot;d/m/Y&quot;}" value="<?php echo $patient['date_of_birth']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control" name="genderPatient" placeholder="Género" id="genderPatient" disabled>
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    ...
                                                    <input type="text" class="form-control" name="countryPatient" id="countryPatient" readonly disabled>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    <label for="departmentPatient" class="form-label">Departamento o provincia</label>
                                                    <input type="text" class="form-control" name="departmentPatient" id="departmentPatient" readonly disabled>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-6">
                                        <div class="mb-2 mb-sm-0">
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="cityPatient" id="cityPatient" readonly disabled>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    ...
                                                    <select class="form-select" name="bloodTypePatient" placeholder="Tipo de sangre" id="bloodTypePatient" readonly disabled>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-2 mb-sm-0">
                                                    ...
                                                    <select class="form-select" id="epsPatient" name="epsPatient">
                                ...
                                <div class="card mt-4" id="infoEntidad" style="display: none;">
                                    <form class="" id="formEntityInvoice" data-wizard-form="">
                                        <div class=" card-body">
                                            ...
                                            <div id="koneksiPreauthorizedProducts" class="d-none">
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>Nombre</th>
                                                    ...
                                                    <tbody id="preauthorizedProductsTableBody">

                                                    </tbody>
                                                    <tfoot>
                                                        <tr>
                                                            <th colspan="2">Monto autorizado total</th>
                                                            <th id="totalAuthorizedValue">$0.00</th>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <template id="templatePreauthorizedProduct">
                                                <tr id="templatePreauthorizedProductRow">
                                                    <td><span id="productName"></span></td>
                                                    <td><span id="productQuantity"></span></td>
                                                    <td><span id="productAuthorizedValue"></span></td>
                                                </tr>
                                            </template>
                                        </div>
                                    </form>
...
<script type="module">
    ...
    import {
        init as initKoneksi,
        completeAuthorization as completeAuthorizationKoneksi
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        ...
        const data = {
            tenantId: tenant,
            belongsTo: "facturacion-compartir",
            type: "whatsapp",
        };
    ...
    function sendMessageWhatsapp(admission) {
    ...
    async function getPaymentMethods() {
        try {
            ...
            const responseFiltered = response.filter(paymentMethod => paymentMethod.category == "transactional");
            if (responseFiltered.length) {
                populatePaymentMethods(responseFiltered);
            } else {
                console.error("Estructura de respuesta desconocida");
            }
        } catch (error) {
    ...
    async function addProductToTable(product, admission, isEntityActive) {
        ...
        let productsByExamRecipe = [];

        if (admission.exam_recipe_id) {
    ...
    function populateBillingTotal() {
        const tbody = document.getElementById("summaryProductsTableBody");
        const filas = tbody.getElementsByTagName("tr");
        let billingTotal = 0;

        const tbodyPayment = document.getElementById("summaryPaymentsTableBody");
        const filasPayment = tbodyPayment.getElementsByTagName("tr");
        let paymentTotal = 0;

        for (let fila of filas) {
            const celdas = fila.getElementsByTagName("td");
            billingTotal += Number(celdas[3].textContent);
        }

        for (let fila of filasPayment) {
            const celdas = fila.getElementsByTagName("td");
            paymentTotal += parseFloat((celdas[2].textContent).replace(/\./g, ''));
        }

        const valores = {
            subtotal: billingTotal.toFixed(2),
            total: billingTotal.toFixed(2),
            paid: paymentTotal.toFixed(2),
            balance: (billingTotal - paymentTotal).toFixed(2),
            total_invoice: billingTotal.toFixed(2)
        };

        // Asignar los valores a cada celda
        Object.keys(valores).forEach(key => {
            const elemento = document.querySelector(`td[data-field="${key}"]`);
            if (elemento) {
    ...
    async function guardarAdmision() {
        ...
        const patientThirdParty = await thirdPartyService.getByExternalIdAndType({
            externalId: globalAdmission.patient_id,
            externalType: "client"
        })

        console.log("patientThirdParty", patientThirdParty);
        ...
        const requestData = {
            ...
            invoice: {
                ...
                third_party_id: patientThirdParty.id || 1,
                sub_type: entitySwitch.checked ? "entity" : "public",
            },
    ...
    async function obtenerDatosAdmision() {
        ...
        // let rutaPdf = await generarFacturaTemporal(dataAdmissionSaved.admission_data.appointment_id);
        // let rutaFinal = reemplazarRuta(rutaPdf);
        // sendMessageWhatsapp(dataAdmissionSaved)

        // console.log("rutaFinal", rutaFinal);

        document.getElementById('finishInvoiceParent').disabled = false;

    }

    const redirTo = new URLSearchParams(window.location.search).get(
        "redirTo"
    ) || "citasControl";

    document.getElementById('finish').addEventListener('click', function() {
        if (redirTo === "postConsultationGestion") {
            window.location.href = redirTo + '?patientId=' + dataAdmissionSaved.admission_data.patient_id;
        } else {
