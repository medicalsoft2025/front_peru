        ...
        <div class="card">
          <div class=" card-body">
            ...
            <div class="row g-3 mb-3">
              ...
              <div class="col-sm-6">
                <div class="mb-2">
                  ...
                  <input class="form-control" type="text" name="secondName" placeholder="Segundo Nombre" id="secondName" disabled value="<?php echo $patient['whatsapp']; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="row g-3 mb-3">
              <div class="col-sm-6">
                <div class="mb-2 mb-sm-0">
                <label class="form-label" for="dateeLaboration ">Fecha de nacimiento*</label>
                <input class="form-control datetimepicker flatpickr-input" id="dateeLaboration" type="text" placeholder="dd/mm/yyyy" data-options="{&quot;disableMobile&quot;:true,&quot;dateFormat&quot;:&quot;d/m/Y&quot;}" readonly="readonly" disabled value="<?php echo $patient['dateeLaboration']; ?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-2">
                  <label class="form-label text-body" for="number">Numero *</label>
                  <input class="form-control" type="text" name="number" placeholder="Segundo Apellido" id="number" disabled value="<?php echo $patient['secondLastName']; ?>">
                </div>
              </div>
            </div>
          </div>
                ...
                <table class="table fs-9 text-body mb-0">
                  <thead class="bg-body-secondary">
                    <tr>
                      ...
                      <th class="ps-5 small text-end" scope="col" style="min-width: 150px;">Descuento</th>
